...
<div class="content-header">
  ...
  <section class="content">
    <div class="container-fluid">
     <a href="{{ Route('add_datadiri') }}" style="font-weight: bold;">Penilaian Kerja Klik Melanjutkan <span class="fa fa-arrow-circle-right"></span></a>
        <!-- /.card-header -->
...
{{-- UNTUK PENILAIAN KERJA BUKAN BAGIAN ADMIN --}}
  @else
    ...
    <section class="content" >
        ...
        <div class="help-block text-center">
          <h1 style="font-family: 'Kaushan Script', cursive;">Kepegawaian Uvers</h1>
        </div>
        <div class="text-center">
          <a href="{{ Route('add_datadiri') }}">Penilaian Kerja Klik Melanjutkan <span class="fa fa-arrow-circle-right"></span></a>
        </div>
