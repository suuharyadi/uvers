                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                          <div class="form-group" >
                            ...
                            <label for="Ruangan">Jenis Nilai :</label>
                            <select class="form-control" name="jenis_nilai">
                              @foreach($nilai_absolut as $valnilab)
                              <option value="{{ $valnilab->type }}" @if($valnilab->type == 'versi_2') selected @endif>{{ $valnilab->type }}</option>
                              @endforeach
                            </select>
                          </div>
                        </div>
