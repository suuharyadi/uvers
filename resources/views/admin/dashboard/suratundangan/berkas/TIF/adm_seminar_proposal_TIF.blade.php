...
<td style="width: 44.3925%; height: 10px;"><span style="font-size: 11pt; font-family: Arial, sans-serif;">{{$koor}} </span><span style="font-size: 11pt; font-family: Arial, sans-serif;"></span></td>
</tr>
<tr style="height: 10px;">
<td style="width: 35.079%; height: 10px;">
<p style="margin: 0in 0in 0.0001pt; font-size: 12pt; font-family: 'Times New Roman', serif;"><span style="font-size: 11pt; font-family: Arial, sans-serif;">&nbsp;</span></p>
...
@if($cek->kelompok_penilaian_proposal == '1')
...
@php
	...
	$Datakpp = DB::table('a_lembar_penilaian_proposal')->where('grup' ,'=', $cek->kelompok_penilaian_proposal)->get();

@endphp

@foreach($Datakpp as $keykpp => $valuekpp)

<tr style="height: 22.45pt;">
<td style="width: .4in; border: solid windowtext 1.0pt; border-top: none; padding: 0in 5.4pt 0in 5.4pt;">
<p style="text-align: center; margin: 0in 0in 0.0001pt; font-size: 12pt; font-family: 'Times New Roman', serif;" align="center"><span style="font-size: 11.0pt; font-family: Arial, sans-serif;">{{ $keykpp + 1 }}</span></p>
</td>
...
<p style="margin: 0in 0in 0.0001pt; font-size: 12pt; font-family: 'Times New Roman', serif;"><span style="font-size: 11.0pt; font-family: Arial, sans-serif;">{{ $valuekpp->materi }}</span></p>
</td>
...
<p style="margin: 0in 0in 0.0001pt; font-size: 12pt; font-family: 'Times New Roman', serif;"><strong><span style="font-size: 11.0pt; font-family: Arial, sans-serif;">{{ $valuekpp->prosentase }}</span></strong></p>
</td>
@if($cek->kelompok_penilaian_proposal == '1')
...
<table style="border: solid windowtext 1.0pt;border-collapse: collapse; font-size: 9.0pt; line-height: 115%; font-family: Arial, sans-serif;" border="1" >
	<thead>
		<tr>
			<th style="padding:3px; vertical-align:middle;">Nilai</th>
			<th style="padding:3px; vertical-align:middle;">Rentang</th>
		</tr>
	</thead>
	<tbody>
		@forelse($NilaiAbsolut as $keyAbsolut => $val)
		<tr>
			<td style="padding:3px; text-align:center; vertical-align: middle;">{{ strtoupper($val->nilai_huruf) }}</td>
			<td style="padding:3px; text-align: center; vertical-align:middle;">{{ $val->nilai_absolut_awal }} - {{ $val->nilai_absolut_akhir }}</td>
		</tr>
		@empty
		<tr>
			<td style="padding:3px; text-align:center; vertical-align: middle;" colspan="3">Tidak ada data</td>
		</tr>
		@endforelse
	</tbody>
</table>
