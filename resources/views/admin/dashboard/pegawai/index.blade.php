    ...
    <div class="row">
      <div class="col-12">
          ...
          <div class="card-body"  style="padding: 0px;">
            ...
            <table id="datatablespegawai" class="table table-dark table-bordered table-hover" style="width: 100%">
              <thead>
                <tr>
...
var detailRows=[]; $('#datatablespegawai tbody').on('click', 'td.details-control', function (){var tr=$(this).closest('tr'); var row=dt.row( tr ); if ( row.child.isShown() ){$('div.slider', row.child()).slideUp( function (){row.child.hide(); tr.removeClass('shown');});}else{row.child( format(row.data()), 'no-padding' ).show(); tr.addClass('shown'); $('div.slider', row.child()).slideDown();}}); dt.on( 'draw', function (){$.each( detailRows, function ( i, id ){$('#'+id+' td.details-control').trigger( 'click' );});});
...
::-webkit-scrollbar-track {
    -webkit-box-shadow: inset 0 0 3px rgba(255, 255, 255); 
    border-radius: 10px;
}
