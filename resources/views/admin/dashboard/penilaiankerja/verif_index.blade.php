              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center; vertical-align:middle;">
                    @if(CekPesan($showCekKelompok->id_user_tujuan, $showCekKelompok->id_user, $id_versi) == 0)
...
function CekPesan($dari, $untuk, $id_versi){

  $cek = DB::table('b_pesan')->select('pesan_dari','pesan_untuk')
      ->where([['pesan_dari','=',$dari],['pesan_untuk','=', $untuk],['id_versi','=',$id_versi]])
      ->count();
