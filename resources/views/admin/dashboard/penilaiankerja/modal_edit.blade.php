         ...
         <h5>Data Diri Umum :</h5>
          <div class="card-body row" style="padding: 1px;">
                          ...
                          <div class="col-md-12">
                            <label for="bpjs_kesehatan">No. BPJS KESEHATAN : </label>
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nomor_bpjs_kes" value="{{ $Ddiri->no_bpjs_kesehatan }}" placeholder="12232323" onkeypress="return isNumberKey(event)" maxlength="30">
                          ...
                          <div class="col-md-12">
                            <label for="bpjs ketenagakerjaan">No. BPJS KETENAGAKERJAAN : </label>
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nomor_bpjs_tenker" value="{{ $Ddiri->no_bpjs_ketenagakerjaan }}" placeholder="96234" onkeypress="return isNumberKey(event)" maxlength="30">
                  ...
                  <div class="form-group col-md-3">
                      <div class="row">
                          <div class="col-md-12" > 
                          <label for="vegetarian">Vegetarian ? :  <font style="color: #007bff" size="2px">*</font></label>
                    ...
                    <div class="form-group col-md-2" >
                      <div class="row">
                          <div class="col-md-12" id="showikrartahun">
                            <label for="Suku">Ikrar Tahun : <font style="color: #007bff" size="2px">*</font></label>
                            <div class="input-group">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fa fa-user"></i></span>
                            </div>
                    ...
                    <div class="form-group col-md-4">
                      <div class="row">
                          <div class="col-md-12" >
                          <label for="status">Status Di Vihara  <font style="color: #007bff" size="2px">*</font></label>
                     ...
                     <div class="form-group col-md-3">
                        <div class="row">
                            <div class="col-md-12">
                            <label for="status">Detail Status Di Vihara <font style="color: #007bff" size="2px">*</font></label>
