...
{	
    ...
    protected function CekProdiKoor($id_pegawai){

        $Data = DB::table('pegawai')
        ->select('pegawai.nama_karyawan')
        ->where('pegawai.id_pegawai','=',$id_pegawai)->first();
        if (is_null($Data)) {
    ...
    public function cekberkasadministrasi(Request $request){
        ...
        $cekData =  DB::table('a_srt_udg_penguji')
                    ...
                    ->join('a_tanda_tangan','a_tanda_tangan.id','=','a_srt_udg_penguji.id_tanda_tangan')
                    ...
                    ->select(   
                                ...
                                'a_srt_udg_penguji.kelompok_penilaian_proposal', 
                                ...
                                'a_tanda_tangan.*',
                                'a_srt_udg_penguji.keterangan_nilai'
        ...
        switch ($cekData->id_berkas_adm) {
            ...
            case '1':
                return view('admin.dashboard.suratundangan.berkas.AK.adm_ujian_proposal_TA_AK', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //akuntansi ujian tugas akhir
            case '2':
                return view('admin.dashboard.suratundangan.berkas.AK.adm_ujian_TA_AK', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //managemen seminar
            case '3':
                return view('admin.dashboard.suratundangan.berkas.MN.adm_seminar_MN', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'koor'=>$this->CekProdiKoor($cekData->id_pegawai),'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //managemen ujian tugas akhir
            case '4':
                return view('admin.dashboard.suratundangan.berkas.MN.adm_ujian_TA_MN', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            ...
            case '5':
                return view('admin.dashboard.suratundangan.berkas.PBM.adm_seminar_proposal_PBM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;

            //Pendidikan Bahasa Mandari Ujian Tugas Akhir
            case '6':
                return view('admin.dashboard.suratundangan.berkas.PBM.adm_ujian_TA_PBM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;

            //Sistem Informasi Seminar Proposal
            case '7':
                return view('admin.dashboard.suratundangan.berkas.SI.adm_seminar_proposal_SI', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Sistem Informasi Ujian Tugas Akhir
            case '8':
                return view('admin.dashboard.suratundangan.berkas.SI.adm_ujian_TA_SI', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Informatika Seminar Proposal
            case '22':
                return view('admin.dashboard.suratundangan.berkas.TIF.adm_seminar_proposal_TIF', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),  'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Informatika tugas akhir
            case '23':
                return view('admin.dashboard.suratundangan.berkas.TIF.adm_ujian_TA_TIF', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen,'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;

            //Teknik Industri Seminar Proposal
            case '18':
                return view('admin.dashboard.suratundangan.berkas.TI.adm_seminar_proposal_TI', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Perangkat Lunak Seminar Proposal
            case '27':
                return view('admin.dashboard.suratundangan.berkas.TPL.adm_seminar_proposal_TPL', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen,'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Perangkat Lunak Ujian TA
            case '28':
                return view('admin.dashboard.suratundangan.berkas.TPL.adm_ujian_TA_TPL', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen,'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),  'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Lingkungan Seminar Proposal TA
            case '24':
                return view('admin.dashboard.suratundangan.berkas.TL.adm_seminar_proposal_TA_TL', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Lingkungan Seminar Kemajuan TA
            case '25':
                return view('admin.dashboard.suratundangan.berkas.TL.adm_seminar_kemajuan_TA_TL', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Teknik Lingkungan Ujian TA 
            case '26':
                return view('admin.dashboard.suratundangan.berkas.TL.adm_ujian_TA_TL', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Seni Musik ujian proposal TA
            case '9':
                return view('admin.dashboard.suratundangan.berkas.SM.adm_ujian_proposal_TA_SM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen,  'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
            //Seni Musik ujian kelayakan TA
            case '10':
                return view('admin.dashboard.suratundangan.berkas.SM.adm_ujian_kelayakan_TA_SM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester,'koor'=>$this->CekProdiKoor($cekData->id_pegawai)]);
                break;
            //Seni Musik ujian pra pertunjukan TA 
            case '11':
                return view('admin.dashboard.suratundangan.berkas.SM.adm_ujian_pra_pertunjukan_TA_SM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester,'koor'=>$this->CekProdiKoor($cekData->id_pegawai) ]);
                break;
            //Seni Musik ujian pertunjukan dan sidang TA 
            case '12':
                return view('admin.dashboard.suratundangan.berkas.SM.adm_ujian_pertunjukan_dan_sidang_TA_SM', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;

            //Seni TARI ujian proposal TA ST (evaluasi 1)
            case '13':
                return view('admin.dashboard.suratundangan.berkas.ST.adm_ujian_proposal_TA_ST_evaluasi_1', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai)]);
                break;

            //Seni TARI ujian materi TA ST (evaluasi 2)
            case '14':
                return view('admin.dashboard.suratundangan.berkas.ST.adm_ujian_materi_TA_ST_evaluasi_2', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai)]);
                break;

            //Seni TARI ujian kelayakan TA ST (evaluasi 3)
            case '15':
                return view('admin.dashboard.suratundangan.berkas.ST.adm_ujian_kelayakan_TA_ST_evaluasi_3', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan,'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai)]);
                break;

            //Seni TARI ujian penyajian TA ST OK
            case '16':
                return view('admin.dashboard.suratundangan.berkas.ST.adm_ujian_penyajian_TA_ST', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai)]);
                break;

            //Seni TARI ujian pertanggung jawaban TA ST OK
            case '17':
                return view('admin.dashboard.suratundangan.berkas.ST.adm_ujian_pertanggungjawaban_TA_ST', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan, 'pilihan' => $request->pilihan_jenis,'tahun_ajar' => $request->tahun_ajar,'semester' => $request->semester, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai), 'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;

            //Teknik Industri Ujian Tugas Akhir
            case '20':
                return view('admin.dashboard.suratundangan.berkas.TI.adm_ujian_tugas_TA_TI', ['cek' => $cekData, 'dospem' => $cekDosenPem, 'dospen' => $cekDosenPen, 'id_udg' => $request->id_undangan, 'pilihan' => $request->pilihan_jenis, 'koor'=>$this->CekProdiKoor($cekData->id_pegawai),  'NilaiAbsolut' => $this->CallTableNilaiAbsolut('DESC', $cekData->keterangan_nilai)]);
                break;
    ...
    protected function CallTableNilaiAbsolut($urutan, $type){
        $Data = DB::table('a_nilai_absolut')->select('*')->where('type','=',$type)->orderBy('nilai_absolut_awal',$urutan)->get();
        return $Data;
    }
	...
	public function showtambahundangan(){
        ...
        $NilaiAbsolut = DB::table('a_nilai_absolut')->select(DB::raw('count(*) as user_count, type'))->groupBy('type')->get();

        $ruangan    = DB::table('a_ruangan')->get();
        return view('admin.dashboard.suratundangan.tambah',['dosen' => $dosen, 'prodi' => $prodi, 'mhs' => $mhs ,'mk' => $mk, 'ruangan' => $ruangan,'NoSuratPembimbing' => $surat_tugas, 'nilai_absolut' => $NilaiAbsolut]);
